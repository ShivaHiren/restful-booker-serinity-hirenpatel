...
public class RestfulCrudTest extends TestBase{
    static String firstname = "Jhon" + TestUtils.getRandomValue();
    static String lastname = "Wick" + TestUtils.getRandomValue();
    static int totalprice = Integer.parseInt(1 + TestUtils.getRandomValue());
    static boolean depositpaid = true;
    static String additionalneeds = "Blanket";
    ...
    @Title("This method will create a new Token")
    @org.junit.Test
    public void test001() {
    ...
    public void test002() {
        ...
        bookingdates.setCheckout("2023-11-15");
    ...
    public void test005() {
        ...
        Assert.assertThat(update, hasValue("Breakfast"));
    }
